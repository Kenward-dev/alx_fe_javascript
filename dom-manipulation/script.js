...
function showRandomQuote() {
    ...
    quoteDisplay.innerHTML = `"${randomQuote.text}"<span class="category">— ${randomQuote.category}</span>`;
}
...
function addQuote() {
    ...
    document.getElementById("quoteDisplay").innerHTML = `"${newQuoteText}"<span class="category">— ${newQuoteCategory}</span>`;
